...
struct BookData {
    ...
    static let books = [
        ...
        BookModel(id: 3, name: "Levent Kapadokya'da", author: "Mustafa Orakçı", illustrator: "Derya Işık Özbay", publisher: "Timaş Çocuk", publishDate: "2019", numberOfPages: 96, coverImage: "levent_kapadokyada", bookSaver: owner1),
        BookModel(id: 4, name: "Levent Kapadokya'da", author: "Mustafa Orakçı", illustrator: "Derya Işık Özbay", publisher: "Timaş Çocuk", publishDate: "2019", numberOfPages: 96, coverImage: "levent_kapadokyada", bookSaver: owner1),
        BookModel(id: 5, name: "Levent Kapadokya'da", author: "Mustafa Orakçı", illustrator: "Derya Işık Özbay", publisher: "Timaş Çocuk", publishDate: "2019", numberOfPages: 96, coverImage: "levent_kapadokyada", bookSaver: owner1),
